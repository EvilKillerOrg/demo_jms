...
public class Subscriber2 {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    // 实例化连接工厂
    connectionFactory = new ActiveMQConnectionFactory(Subscriber2.USERNAME, Subscriber2.PASSWORD, Subscriber2.BROKERURL);
    ...
    try {
      ...
      messageConsumer.setMessageListener(new Subscriber2Listener());
      while (true) {
        // 这不暂停一下订阅不上
        Thread.sleep(1000);
      }
